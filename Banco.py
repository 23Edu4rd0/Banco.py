...
class Banco:  # Define a classe Banco
    ...
    def depositar_fundo(self):  
        ...
        self.historico = self.depositar.historico  # Atualiza o histórico da conta com o histórico de depósitos
        self.sacar.saldo = self.saldo  # Garante que o saldo no objeto 'sacar' seja atualizado com o saldo atual
    ...
    def sacar_fundo(self):  
        ...
        self.historico = self.sacar.historico  # Atualiza o histórico da conta com o histórico de saques
        self.depositar.saldo = self.saldo  # Garante que o saldo no objeto 'depositar' seja atualizado com o saldo atual
